                        ...
                        psa_storage_create_flags_t create_flags)
{
    ...
    status = tfm_ns_interface_dispatch((veneer_fn)tfm_ps_set_req,
                                       (void *)in_vec,  IOVEC_LEN(in_vec),
                                       (void *)NULL, 0);
                        ...
                        size_t *p_data_length)
{
    ...
    status = tfm_ns_interface_dispatch((veneer_fn)tfm_ps_get_req,
                                       (void *)in_vec,  IOVEC_LEN(in_vec),
                                       (void *)out_vec, IOVEC_LEN(out_vec));
                             ...
                             struct psa_storage_info_t *p_info)
{
    ...
    status = tfm_ns_interface_dispatch((veneer_fn)tfm_ps_get_info_req,
                                       (void *)in_vec,  IOVEC_LEN(in_vec),
                                       (void *)out_vec, IOVEC_LEN(out_vec));
...
psa_status_t psa_ps_remove(psa_storage_uid_t uid)
{
    ...
    status = tfm_ns_interface_dispatch((veneer_fn)tfm_ps_remove_req,
                                       (void *)in_vec,  IOVEC_LEN(in_vec),
                                       (void *)NULL, 0);
...
uint32_t psa_ps_get_support(void)
{
    ...
    (void)tfm_ns_interface_dispatch((veneer_fn)tfm_ps_get_support_req,
                                    (void *)NULL,  0,
                                    (void *)out_vec, IOVEC_LEN(out_vec));
